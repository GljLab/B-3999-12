...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'certificates', name: 'MyCertificates', component: () => import('@/views/MyCertificates.vue') },
      { path: 'certificate/generate', name: 'CertificateGenerator', component: () => import('@/views/CertificateGenerator.vue') },
      { path: 'certificate/:id', name: 'CertificateDetail', component: () => import('@/views/CertificateDetail.vue') },
      { path: 'certificate-verify', name: 'CertificateVerify', component: () => import('@/views/CertificateVerify.vue') },
      { path: 'certificate-rankings', name: 'CertificateRankings', component: () => import('@/views/CertificateRankings.vue') },
      { path: 'certificate-stats', name: 'CertificateStats', component: () => import('@/views/CertificateStats.vue'), meta: { roles: ['SYS_ADMIN'] } },
      { path: 'farmer-certificates', name: 'FarmerCertificates', component: () => import('@/views/FarmerCertificates.vue'), meta: { roles: ['FARMER', 'SYS_ADMIN'] } },
